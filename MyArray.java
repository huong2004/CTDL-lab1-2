...
public class MyArray {
	 ...
	 * mirror Example: input [1, 2, 3] ==> output: [1, 2, 3, 3, 2, 1]
	 *
	 */
	public int[] mirror() {
	...
	/*
	 * removes all duplicate elements from an array and returns a new array Input: 1
	 * 3 5 1 3 7 9 8 Output: 1 3 5 7 9 8
	 */
	...
	public int[] removeDuplicates() {
		...
		int[] result = arrayListToArray(listArr);
		return result;
	}
